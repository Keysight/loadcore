...
%> docker load -i LoadCore-Agent-Docker-3.2.0.6-eb1d63b274-20220419T174031Z.tar.gz
...
%> docker create --name loadcore-agent --cap-add=NET_ADMIN loadcore-agent:3.2.0.6-eb1d63b274 MIDDLEWARE-IP eth0 eth1
...
%> docker tag loadcore-agent:3.2.0.6-eb1d63b274 <PRIVATE-DOCKER-REGISTRY>/loadcore-agent:3.2.0.6-eb1d63b274

3. Push the container in the private docker registry:
%> docker push <PRIVATE-DOCKER-REGISTRY>/loadcore-agent:3.2.0.6-eb1d63b274
...
%> helm install -f my_values.yaml loadcore-agent ./load-core-agent-3.2.0-6+eb1d63b274.20220419.tgz
...
%> podman load -i LoadCore-Agent-Docker-3.2.0.6-eb1d63b274-20220419T174031Z.tar.gz

3. See the loaded image details:
%> podman images

4. Tag the loadcore image using the same image ID returned by 'podman images', for example:
%> podman tag eb1d63b274 $REGISTRY/loadcore/loadcore-agent:3.2.0.6-eb1d63b274

5. Push the loadcore image to the internal image registry:
%> podman push --tls-verify=false $REGISTRY/loadcore/loadcore-agent:3.2.0.6-eb1d63b274
